...
`ifdef WARP
`define CY_BLK_DIR "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0"
`include "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0"
`include "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_UART_v2_50"
`include "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_UART_v2_50\B_UART_v2_50.v"
`else
`define CY_BLK_DIR "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_UART_v2_50"
`include "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\B_UART_v2_50\B_UART_v2_50.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal"
...
`ifdef WARP
`define CY_BLK_DIR "C:\H_Da Softwares & Projects\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\OneTerminal"
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("57b83523-813a-43b0-afde-f1d4c4e97b44"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6193b034-9ad7-4705-8253-887ff9bf5e60"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    defparam Timer_1ms.DeviceFamily = "PSoC5";
    defparam Timer_1ms.InterruptOnCapture = 0;
    defparam Timer_1ms.InterruptOnTC = 1;
    defparam Timer_1ms.Resolution = 16;
    defparam Timer_1ms.SiliconRevision = "0";
	...
	cy_clock_v1_0
		#(.id("af65b627-e0c5-4e9e-84a8-2c9cc5e6cdcd"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
    ...
    defparam Timer_2secs.DeviceFamily = "PSoC5";
    defparam Timer_2secs.InterruptOnCapture = 0;
    defparam Timer_2secs.InterruptOnTC = 1;
    defparam Timer_2secs.Resolution = 24;
    defparam Timer_2secs.SiliconRevision = "0";
